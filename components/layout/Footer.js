...
Calle 5 entre 2 y 4 Parque Ind. Gral. Savio Ruta 88 Km. 6,5 (7601) Batán, Mar del Plata, Bs. As., Argentina.</p>
    ...
    <div className="flex-grow flex flex-wrap md:pr-20 -mb-10 md:text-left text-center order-first">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 className="title-font font-medium text-gray-600 tracking-widest text-sm mb-3">CONTACTO</h2>
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">info@emegecalefaccion.com.ar</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">+54 (0223) 464-1124 / 1636</a>
          </li>
        </nav>
      </div>
    </div>
