...
const Scroll = () => {
    ...
    // Chequea si el eje "Y" supera los 400 pixeles entonces la flecha se verá (true)
    ...
    if( typeof window !== 'undefined'){ // esta línea es porque la variable window no está definida. Si no pongo el condicional, tira error.
    ...
    return ( 
        ...
        className="w-12 md:w-14 fixed bottom-5 right-5">
            { showArrow?     
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="#ef7b0b">
