    ...
    <section className=" body-font bg-gray-100">
      <div className="container px-5 md:py-24 py-12 mx-auto flex flex-wrap">
        <div className="md:w-2/3 w-full mx-auto">
          <Link href="/patagonia">
            <a className="flex flex-wrap w-full h-96 bg-gray-100 md:py-32 relative mb-4 overflow test rounded-lg">
              <img
                alt="gallery"
              ...
              <div className="details text-white">
                ...
                <p className="leading-relaxed">
                  Calor frontal que llega más rápido a todo el ambiente. + INFO
                </p>
              </div>
            </a>
          </Link>
          <div className="flex flex-wrap -mx-2">
            <div className="md:w-1/2 p-2 w-full">
              <Link href="/euro">
                <a className="flex flex-wrap w-full bg-gray-100 md:py-32 py-20 relative mb-4 overflow test rounded-lg">
                  <img
                    alt="gallery"
                  ...
                  <div className="details text-white">
                    ...
                    <p className="leading-relaxed">
                      Diseño compacto que armoniza con cada espacio de tu hogar.
                    </p>
                  </div>
                </a>
              </Link>
