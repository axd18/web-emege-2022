    ...
    return ( 
        ...
        <section className="body-font">
          <div className="py-24 mx-auto flex flex-wrap">
            <div className="flex flex-wrap w-full bg-gray-100 md:py-24 px-10 relative mb-4">
              <img alt="gallery" className="w-full object-cover md:h-auto object-center block absolute inset-0" src="img-section-main-patagonia-2.jpg"/>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gray-200 text-gray-600 body-font">
          ...
          <div className="flex flex-col text-center w-full mb-12">
            <h1 className="sm:text-3xl text-2xl font-medium title-font text-gray-600">Línea Patagonia</h1>
            <div className="h-1 mx-auto bg-gradient-to-r from-yellow-500 to-yellow-600 w-24 mt-3 rounded mb-8"></div>
          </div>
          <div className="md:flex">
            { 
              patagonia.map(({title, area, span, medidas, image, manual}, i) => (
