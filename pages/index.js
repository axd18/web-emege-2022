...
const Index = () => {
  return (
    <div>
      ...
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Línea Patagonia</h1>
            ...
            <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
              <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="https://dummyimage.com/720x400" alt="blog"/>
                <div class="p-6">
                  ...
                  <h1 class="title-font text-lg font-medium text-gray-900 mb-3">TB 1900 Kcal.</h1>
                  <ul class="leading-relaxed mb-3">
                    <li>Área a calefaccionar: </li>
